 ...
 *
 * @wordpress-plugin
 * Plugin Name:       LRB Business Hours
 * Plugin URI:        http://www.camerondfuller.com
 * Description:       A widget to set business hours on the site.
 * Version:           1.0.0
 * Author:            Cameron Fuller
 * Author URI:        http://www.camerondfuller.com
 * License:           GPL-2.0+
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'A widget to update the Le Red Bread Bakery\'s hours.'
			)
		);
